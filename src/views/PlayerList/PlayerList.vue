<template>
    <div class="x-container x-container--auto-height" ref="playerListRef">
        <div class="flex h-full min-h-0 flex-col overflow-hidden">
            <div
                data-testid="player-list-details"
                class="shrink-0 max-h-[45%] overflow-y-auto overflow-x-hidden pr-1 pb-2">
                        <div
                            ...
                            <div
                                class="ml-2"
                                style="display: flex; flex-direction: column; min-width: 320px; width: 100%">
            ...
            <div data-testid="player-list-table" class="current-instance-table flex min-h-0 min-w-0 flex-1">
                <DataTableLayout
